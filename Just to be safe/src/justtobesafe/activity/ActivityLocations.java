...
public class ActivityLocations {
    ...
    public static final String homeMenu="/justtobesafe/homemenu/homemenu_activity.fxml";
    public static final String loginActivity="/justtobesafe/login/login_activity.fxml";
